...
| 캘린더 | 기기 캘린더와 일정 연동 |
| 생체인증 (Face ID/지문) | 앱 잠금 해제 (생체정보 자체는 기기에만 저장, 인증 성공/실패 여부만 처리) |
...
| 서비스 제공 | 할 일 관리, 캘린더(주간/월간), 친구 공유, 콕 찌르기, 주간 성취 배지 등 핵심 기능 제공. 공개 설정된 할 일은 친구에게 표시되며, 콕 찌르기 메시지는 상대방에게 전달됩니다. |
| AI 기능 제공 | 할 일 자동 파싱, 주간·월간 AI 리포트 생성(할 일 통계 분석·성취 요약), 반복 패턴 분석 및 자동 제안 등 AI 기반 기능 |
| 구독 및 결제 관리 | 유료 구독 처리, 결제 상태 관리, 영수증 검증 |
| 알림 발송 | 할 일 리마인더(시작 1시간 전·10분 전), 아침·저녁 리마인더, 소셜 알림, 서비스 공지 |
...
1. 본 개인정보처리방침은 **2026년 3월 5일**부터 시행합니다.
2. 이전 개인정보처리방침(2026년 3월 3일 시행)은 본 방침 시행과 동시에 효력을 상실합니다.
