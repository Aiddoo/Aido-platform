...
import ChatBubbleIconSvg from '@assets/icons/ic_chat_bubble.svg';
...
import HeartIconSvg from '@assets/icons/ic_heart.svg';
import HeartFilledIconSvg from '@assets/icons/ic_heart_filled.svg';
import InfoIconSvg from '@assets/icons/ic_info.svg';
import KakaoIconSvg from '@assets/icons/ic_kakao.svg';
import EnglishIconSvg from '@assets/icons/ic_lang_en.svg';
import KoreanIconSvg from '@assets/icons/ic_lang_ko.svg';
...
import RobotIconSvg from '@assets/icons/ic_robot.svg';
import RobotPixelIconSvg from '@assets/icons/ic_robot_pixel.svg';
...
export const ChatBubbleIcon = createStyledIcon(ChatBubbleIconSvg);
...
export const EnglishIcon = createStyledIcon(EnglishIconSvg);
...
export const HeartIcon = createStyledIcon(HeartIconSvg);
export const HeartFilledIcon = createStyledIcon(HeartFilledIconSvg);
export const InfoIcon = createStyledIcon(InfoIconSvg);
export const KakaoIcon = createStyledIcon(KakaoIconSvg);
export const KoreanIcon = createStyledIcon(KoreanIconSvg);
...
export const RobotIcon = createStyledIcon(RobotIconSvg);
export const RobotPixelIcon = createStyledIcon(RobotPixelIconSvg);
