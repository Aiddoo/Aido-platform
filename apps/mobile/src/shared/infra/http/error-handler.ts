...
const MOBILE_ERROR_MESSAGES: Partial<Record<ErrorCodeType, string>> = {
  ...
  USER_0611: '계정 설정에 문제가 있어요. 다시 시도해주세요.',
  USER_0612: '회원 탈퇴를 위해 비밀번호를 입력해주세요',
  USER_0613: '소셜 로그인 계정은 비밀번호를 변경할 수 없어요',
  USER_0614: '이미 비밀번호가 설정되어 있어요',
  ...
  TODO_0810: '이동할 위치의 할 일을 찾을 수 없어요',
  TODO_0811: '이 카테고리의 할 일이 최대 한도에 도달했어요',
  TODO_0812: '한 번에 생성할 수 있는 반복 할 일 수를 초과했어요',
  TODO_0813: '반복 할 일을 생성하면 카테고리 한도를 초과해요',
  TODO_0821: '하위 항목을 더 추가할 수 없어요',
  TODO_0822: '하위 항목을 찾을 수 없어요',

  // =========================================================================
  // Todo 카테고리 (TODO_CATEGORY)
  // =========================================================================
  TODO_CATEGORY_0851: '카테고리를 찾을 수 없어요',
  TODO_CATEGORY_0852: '다른 사용자의 카테고리예요',
  TODO_CATEGORY_0853: '같은 이름의 카테고리가 이미 있어요',
  TODO_CATEGORY_0854: '최소 1개의 카테고리가 필요해요',
  TODO_CATEGORY_0855: '카테고리에 할 일이 있어요. 이동할 카테고리를 선택해주세요.',
  TODO_CATEGORY_0856: '이동할 카테고리를 선택해주세요',
  TODO_CATEGORY_0857: '카테고리를 더 만들 수 없어요',
  ...
  // 콕 찌르기 (NUDGE)
  // =========================================================================
  NUDGE_1101: '오늘 콕 찌르기 횟수를 모두 사용했어요',
  NUDGE_1102: '이미 콕 찌른 할 일이에요',
  NUDGE_1103: '친구에게만 콕 찌를 수 있어요',
  NUDGE_1104: '자신에게는 콕 찌를 수 없어요',
  NUDGE_1105: '콕 찌르기를 찾을 수 없어요',
  ...
  // AI 서비스 (AI)
  // =========================================================================
  AI_1301: 'AI 서비스를 일시적으로 사용할 수 없어요',
  AI_1302: '문장을 이해하지 못했어요. 다시 시도해주세요.',
  AI_1303: '이번 달 AI 사용 횟수를 모두 사용했어요',

  // =========================================================================
  // 관리자 (ADMIN)
  // =========================================================================
  ADMIN_1401: '접근 권한이 없어요',
  ADMIN_1402: '알림 대상을 찾을 수 없어요',
