...
export const ERROR_CODE = {
	...
	KAKAO_TOKEN_VERIFICATION_FAILED: "KAKAO_TOKEN_VERIFICATION_FAILED",
	...
	GOOGLE_TOKEN_VERIFICATION_FAILED: "GOOGLE_TOKEN_VERIFICATION_FAILED",
	GOOGLE_EMAIL_NOT_PROVIDED: "GOOGLE_EMAIL_NOT_PROVIDED",
	...
	NAVER_TOKEN_VERIFICATION_FAILED: "NAVER_TOKEN_VERIFICATION_FAILED",
	NAVER_USER_INFO_FAILED: "NAVER_USER_INFO_FAILED",
	NAVER_ACCOUNT_ALREADY_LINKED: "NAVER_ACCOUNT_ALREADY_LINKED",
	NAVER_UNLINK_FAILED: "NAVER_UNLINK_FAILED",
...
export const ERROR_MESSAGE: Record<ErrorCode, string> = {
	...
	[ERROR_CODE.SOCIAL_TOKEN_EXPIRED]: "소셜 인증 토큰이 만료되었습니다.",
	...
	// 애플 로그인
	[ERROR_CODE.APPLE_AUTH_FAILED]: "애플 로그인에 실패했습니다.",
	...
	// 구글 로그인
	[ERROR_CODE.GOOGLE_AUTH_FAILED]: "구글 로그인에 실패했습니다.",
	[ERROR_CODE.GOOGLE_TOKEN_INVALID]: "구글 인증 토큰이 유효하지 않습니다.",
	[ERROR_CODE.GOOGLE_TOKEN_VERIFICATION_FAILED]:
		"구글 토큰 검증에 실패했습니다.",
	[ERROR_CODE.GOOGLE_EMAIL_NOT_PROVIDED]:
		"구글 계정에서 이메일 정보를 가져올 수 없습니다.",
	[ERROR_CODE.GOOGLE_ACCOUNT_ALREADY_LINKED]:
		"이미 다른 계정에 연동된 구글 계정입니다.",
	[ERROR_CODE.GOOGLE_UNLINK_FAILED]: "구글 계정 연동 해제에 실패했습니다.",

	// 네이버 로그인
	[ERROR_CODE.NAVER_AUTH_FAILED]: "네이버 로그인에 실패했습니다.",
	[ERROR_CODE.NAVER_TOKEN_INVALID]: "네이버 인증 토큰이 유효하지 않습니다.",
	[ERROR_CODE.NAVER_TOKEN_VERIFICATION_FAILED]:
		"네이버 토큰 검증에 실패했습니다.",
	[ERROR_CODE.NAVER_USER_INFO_FAILED]:
		"네이버 사용자 정보를 가져오는데 실패했습니다.",
	[ERROR_CODE.NAVER_ACCOUNT_ALREADY_LINKED]:
		"이미 다른 계정에 연동된 네이버 계정입니다.",
	[ERROR_CODE.NAVER_UNLINK_FAILED]: "네이버 계정 연동 해제에 실패했습니다.",
	...
	// 계정 관련
	[ERROR_CODE.ACCOUNT_NOT_FOUND]: "연결된 계정을 찾을 수 없습니다.",
	...
	[ERROR_CODE.CANNOT_UNLINK_LAST_ACCOUNT]:
...
export const ERROR_HTTP_STATUS: Partial<Record<ErrorCode, HttpStatus>> = {
	...
	[ERROR_CODE.ACCOUNT_NOT_FOUND]: HttpStatus.NOT_FOUND,
	...
	[ERROR_CODE.SOCIAL_TOKEN_EXPIRED]: HttpStatus.UNAUTHORIZED,
	[ERROR_CODE.KAKAO_AUTH_FAILED]: HttpStatus.UNAUTHORIZED,
	[ERROR_CODE.KAKAO_AUTH_CODE_INVALID]: HttpStatus.UNAUTHORIZED,
	[ERROR_CODE.KAKAO_TOKEN_REQUEST_FAILED]: HttpStatus.UNAUTHORIZED,
	[ERROR_CODE.KAKAO_TOKEN_VERIFICATION_FAILED]: HttpStatus.UNAUTHORIZED,
	[ERROR_CODE.APPLE_AUTH_FAILED]: HttpStatus.UNAUTHORIZED,
	...
	[ERROR_CODE.GOOGLE_AUTH_FAILED]: HttpStatus.UNAUTHORIZED,
	[ERROR_CODE.GOOGLE_TOKEN_INVALID]: HttpStatus.UNAUTHORIZED,
	[ERROR_CODE.GOOGLE_TOKEN_VERIFICATION_FAILED]: HttpStatus.UNAUTHORIZED,
	[ERROR_CODE.GOOGLE_EMAIL_NOT_PROVIDED]: HttpStatus.UNAUTHORIZED,
	[ERROR_CODE.NAVER_AUTH_FAILED]: HttpStatus.UNAUTHORIZED,
	[ERROR_CODE.NAVER_TOKEN_INVALID]: HttpStatus.UNAUTHORIZED,
	[ERROR_CODE.NAVER_TOKEN_VERIFICATION_FAILED]: HttpStatus.UNAUTHORIZED,
	...
	[ERROR_CODE.GOOGLE_ACCOUNT_ALREADY_LINKED]: HttpStatus.CONFLICT,
	[ERROR_CODE.NAVER_ACCOUNT_ALREADY_LINKED]: HttpStatus.CONFLICT,

	// 400 BAD_REQUEST
	[ERROR_CODE.CANNOT_UNLINK_LAST_ACCOUNT]: HttpStatus.BAD_REQUEST,
	...
	[ERROR_CODE.GOOGLE_UNLINK_FAILED]: HttpStatus.BAD_GATEWAY,
	[ERROR_CODE.NAVER_USER_INFO_FAILED]: HttpStatus.BAD_GATEWAY,
	[ERROR_CODE.NAVER_UNLINK_FAILED]: HttpStatus.BAD_GATEWAY,
