 ...
 * - **시간대 습관**: 특정 시간대에 집중된 할 일 패턴 → 해당 시간대 활용 제안
 * - **요일 습관**: 특정 요일에 집중된 할 일 패턴 → 해당 요일 활용 제안
 *
 * ### 분석 스케줄
 * - 매일 KST 07:30에 자동 분석
...
| **시간대 습관** | 특정 시간대 집중 | 3회 | 0.5~0.85 | 아침 7~9시에 운동 관련 투두 집중 → 해당 시간대 활용 제안 |
| **요일 습관** | 특정 요일 집중 | 3회 | 0.5~0.85 | 월/수/금에 학습 투두 집중 → 해당 요일 활용 제안 |
