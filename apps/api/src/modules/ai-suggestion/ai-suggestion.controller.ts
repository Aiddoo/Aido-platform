 ...
 * - AI는 계산된 인사이트 + 원시 투두 데이터를 기반으로 제안만 생성
 *
 * ### 분석 스케줄
 * - 매일 KST 07:30에 자동 분석
...
## 🧠 AI 제안 유형 (6가지 중 최대 5개)

서버에서 사전 계산한 통계 + 날씨 + 시즌 컨텍스트를 기반으로 **6가지 유형**의 맞춤 루틴을 제안합니다:
...
| **반복 패턴** | 같은 제목 3회+ / 습관 강화 / 재도전 | 0.50~0.95 | "팀 미팅" 반복 제안, "독서 30분" 가벼운 버전 |
