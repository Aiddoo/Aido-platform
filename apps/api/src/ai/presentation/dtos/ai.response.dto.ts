...
export class ParseTodoResponseDto extends createZodDto(parseTodoResponseSchema) {}
export class ParsedMemoDataDto extends createZodDto(parsedMemoDataSchema) {}
export class ParseMemoResponseDto extends createZodDto(parseMemoResponseSchema) {}
